    ...
    <header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
      <nav
        ...
        <div class="flex items-center justify-between">
          <a class="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">Sipencak DPMPTSP Kepri</a>
          <div class="md:hidden">
            <button type="button"
              ...
              <div
                ...
                <div
                  ...
                  <button type="button"
                    ...
                    Sub Menu
                    <svg class="md:-rotate-90 ms-2 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
